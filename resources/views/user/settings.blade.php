  ...
  <div class="row">
    <div class="col-lg-6 col-lg-push-3 col-md-6 col-md-push-3 col-sm-8 col-sm-push-2 col-xs-12">
      <div class="content-box">
          ...
          @form(array('role'=>'form','id'=>'loginform','class'=>'form-horizontal'))
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                @password('password', array('class'=>'form-control','placeholder'=> trans('user.new_password')))
              </div>
            </div>
            <div class="form-group">
              <label for="password_confirmation" class="col-lg-4 control-label">{{ trans('user.confirm_password') }}</label>
              <div class="col-lg-8">
                @password('password_confirmation', array('class'=>'form-control','placeholder'=>trans('user.confirm_password')))
              </div>
            </div>
            <div class="form-group">
