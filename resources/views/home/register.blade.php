                ...
                <div class="content-box register-form">
                    ...
                    @form(['route' => 'auth.register'])
                        <div class="form-group">
                            @label('username', trans('home.username'), ['class'=>'control-label'])
                            @text('username', null, ['class'=>'form-control','placeholder'=>trans('home.username_placeholder')])
                        </div>
                        <div class="form-group">
                            @label('email', trans('home.email'), ['class'=>'control-label'])
                            @text('email', null, ['class'=>'form-control','placeholder'=>trans('home.email_placeholder')])
                        </div>
                        <div class="form-group">
                            @label('password', trans('home.password'), ['class'=>'control-label'])
                            @password('password', ['class'=>'form-control','placeholder'=>trans('home.password_placeholder')])
                        </div>
                        <div class="form-group">
                            @label('password_confirmation', trans('home.confirm_password'), ['class'=>'control-label'])
                            @password('password_confirmation', ['class'=>'form-control','placeholder'=>trans('home.confirm_password_placeholder')])
                        </div>
                        <div class="form-group">
