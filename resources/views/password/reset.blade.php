        ...
        <div class="row">
            <div class="col-lg-4 col-lg-push-4 col-md-6 col-md-push-3 col-sm-8 col-sm-push-2">
                <div class="content-box login-form">
                    ...
                    @form(['route' => 'auth.reset'])
                        @hidden('token', $token)

                        <div class="form-group">
                            @label('email', trans('password.email'), [ 'class' => 'control-label' ])
                            @text('email', null, ['class'=>'form-control', 'placeholder' => trans('password.email_reset_placeholder')])
                        </div>
                        <div class="form-group">

                            @password('password', array('class'=>'form-control middle','placeholder'=>trans('password.new_password')))
                        </div>
                        <div class="form-group">
                            @password('password_confirmation', array('class'=>'form-control bottom','placeholder'=>trans('password.confirm_password')))
                        </div>
                        <div class="form-group">
