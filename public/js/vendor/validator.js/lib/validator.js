...
(function() {
  ...
  // messages
  var _messages = window['validator.messages'] || {
  ...
  var _resolvers = {
    ...
    allow: function(attribute, value, parameters) {
  ...
  var Validator = function(input, rules, attributes, customMessages) {
    ...
    _attributes    = extend({}, _attributes, attributes || {});
    _parsed      = null;
  };
  ...
  Validator.prototype = {
     ...
     */
    passes: function() {
      if (Validator._parsed) {
        return Validator._parsed;
      };
   ...
   * @return {Object}
   */
  Validator.make = function(data, rule, attributes, messages){
    var v = new Validator(data, rule, attributes, messages);
    v.passes();
